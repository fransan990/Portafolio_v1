            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav>
                        ...
                        <Button variant="outline-dark" className="mx-2" onClick={() => clickLinkOut('https://drive.google.com/uc?export=download&id=1DSHJHPjrekWp_lu7WE0FtfPLY2sIYwNd')}>Descargar curriculum</Button>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar >
